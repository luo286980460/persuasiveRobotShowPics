...
// 说明：	添加边框分区
LEDNETSDK_API int _CALL_STD add_broder(unsigned long program, unsigned long broder_area, int x, int y, int w, int h, int transparency, _TEXT_CHAR* areaXYWH = (_TEXT_CHAR*)(&("")));
